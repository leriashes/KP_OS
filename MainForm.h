...
namespace KPOS {
	...
	public:
		MainForm(void)
		{
			...
			for (int i = 0; i < 184; i++)
			{
				programms.push_back(gcnew cliext::vector<int>());

				for (int j = 0; j < 3; j++)
				{
					programms[i]->push_back(0);
				}
			}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_DelProcess->Location = System::Drawing::Point(144, 542);
			...
			this->groupBox_read->Location = System::Drawing::Point(390, 3);
			...
			// maskedTextBox7
			// 
			this->maskedTextBox7->Location = System::Drawing::Point(367, 73);
			this->maskedTextBox7->Mask = L"000";
			...
			this->label192->Location = System::Drawing::Point(226, 76);
			this->label192->Name = L"label192";
			this->label192->Size = System::Drawing::Size(119, 13);
			this->label192->TabIndex = 13;
			this->label192->Text = L"Количество символов";
			// 
			// maskedTextBox8
			// 
			this->maskedTextBox8->Location = System::Drawing::Point(367, 26);
			...
			this->maskedTextBox8->TextChanged += gcnew System::EventHandler(this, &MainForm::maskedTextBox8_TextChanged);
			// 
			// label193
			// 
			this->label193->AutoSize = true;
			this->label193->Location = System::Drawing::Point(226, 29);
			this->label193->Name = L"label193";
			this->label193->Size = System::Drawing::Size(80, 13);
			this->label193->TabIndex = 11;
			this->label193->Text = L"Длительность";
			// 
			// maskedTextBox3
			// 
			...
			this->button_readAction->Location = System::Drawing::Point(446, 118);
			this->button_readAction->Name = L"button_readAction";
			this->button_readAction->Size = System::Drawing::Size(135, 23);
			...
			this->ClientSize = System::Drawing::Size(1015, 595);
			this->Controls->Add(this->button_start);
			this->Controls->Add(this->panel_Main);
			this->Controls->Add(this->button_DelProcess);
			this->Controls->Add(this->button_AddProcess);
			this->MaximizeBox = false;
			this->MaximumSize = System::Drawing::Size(1031, 633);
			this->MinimumSize = System::Drawing::Size(1031, 633);
...
private: 
	...
	cliext::vector<cliext::vector<int>^> programms;


	void checkReady(System::String^ name, System::String^ period, System::String^ number, System::Windows::Forms::Button^ readyButton);
	void selectProcess(int index);
	void unselectProcess();
	void addAction(System::Object^ sender, System::EventArgs^ e, System::Drawing::Color color, System::String^ text, int actionType, int code);
...
private: System::Void maskedTextBox8_TextChanged(System::Object^ sender, System::EventArgs^ e);
private: System::Void maskedTextBox7_TextChanged(System::Object^ sender, System::EventArgs^ e);
private: System::Void maskedTextBox5_TextChanged(System::Object^ sender, System::EventArgs^ e);
